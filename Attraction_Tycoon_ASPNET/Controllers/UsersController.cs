...
namespace Attraction_Tycoon_ASPNET.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(Attraction_Tycoon_ASPNETContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                users = users.Where(c => c.login.Contains(searchString));
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,login")] User user)
        {
            if (id != user.id)
            {
                return NotFound();
